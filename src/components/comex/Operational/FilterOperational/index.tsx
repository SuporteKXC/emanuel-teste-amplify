...
export const FilterOperational = (props: FilterOperationalProps) => {
  ...
  const onSubmit = useCallback<SubmitHandler<IOperationalFilter>>(
    async (data): Promise<void> => {
      try {
        ...
        const diff = new Date(data!.registerDateEnd!).getTime() - new Date(data!.registerDateStart!).getTime() 
  ...
  return (
    <Form ref={formRef} onSubmit={props.customOnSubmit ? props.customOnSubmit : onSubmit} placeholder="">
      <S.Filter>
        ...
        <S.GridContainer gridReapt={5}>
          ...
          {filterIsShown("csrName") ? (
            <Input name="csrName" label={t("comex.filterandButton.csrName")} />
          ) : (
            <></>
          )}
        ...
        <S.GridContainer gridReapt={4}>
          ...
          {filterIsShown("customsBrokerProcess") ? (
            <Input name="customsBrokerProcess" label={t("comex.filterandButton.customsBrokerProcess")} />
          ) : (
            <></>
          )}
        </S.GridContainer>
        ...
        <S.GridContainerText>
          ...
          {filterIsShown("poItem") ? (
            <Input name="poItem" label={t("comex.filterandButton.poItem")} />
          ) : (
            <></>
          )}
          {filterIsShown("product") ? (
            <Input name="product" label={t("comex.filterandButton.product")} />
          ) : (
            <></>
          )}
          {filterIsShown("shipper") ? (
            <Input name="shipper" label={t("comex.filterandButton.shipper")} />
          ) : (
            <></>
          )}
          ...
          {filterIsShown("modal") ? (
            <Input name="modal" label={t("comex.filterandButton.modal")} />
          ) : (
            <></>
          )}
        </S.GridContainerText>
